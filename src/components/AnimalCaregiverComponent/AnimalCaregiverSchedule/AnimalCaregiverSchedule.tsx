...
const AnimalcaregiverSchedule: React.FC = () => {
  const [schedule, setSchedule] = useState<AnimalcaregiversSchedule>({
    id: 0, 
    scheduletype: "长期",
    totalhours: "", 
    frequency: "每天", 
  ...
  const handleSubmit = () => {
    ...
    fetch(API_URL, {
      ...
      .then((data) => {
        ...
        const animalcaregiverformId = data.animalcaregiverform_id;
        // You can show a success message to the user or navigate to another page

        navigate(
          `/signup_animalcaregiver/details/schedule/ads?animalcaregiverformId=${animalcaregiverformId}&phone=${phoneNumber}`
        );
      })
      .catch((error) => {
...
export default AnimalcaregiverSchedule;
