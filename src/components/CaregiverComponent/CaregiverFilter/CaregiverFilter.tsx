...
const CaregiverFilter: React.FC<CaregiverFilterProps> = ({
  ...
  const handleImmediateFilterChange = () => {
    const newFilter = { location, age, gender, experience, hourlycharge };
  ...
  return (
    <div>
      <span
        className="text-blue-600 hover:text-blue-900 font-semibold text-sm cursor-pointer"
