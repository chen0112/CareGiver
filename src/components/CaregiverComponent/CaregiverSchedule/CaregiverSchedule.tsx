...
const CaregiverSchedule: React.FC = () => {
  ...
  const handleSubmit = () => {
    ...
    const API_URL = `${BASE_URL}/api/caregiver/caregiver_schedule`; // Replace with your actual API endpoint
    ...
    fetch(API_URL, {
      ...
      .then((data) => {
        ...
        navigate(
          `/signup_caregiver/schedule/ads?caregiverId=${caregiverId}&phone=${phoneNumber}`
        );
      })
      .catch((error) => {
