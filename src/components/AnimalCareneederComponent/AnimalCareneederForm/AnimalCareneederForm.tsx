...
interface AnimalCareneederFormProps {
  API_URL: string;
  API_URL_UPLOAD: string;
  updateAnimalCareneeders: (newCaregiver: AnimalCareneederForm) => void;
...
const AnimalCareneederWebForm: React.FC<AnimalCareneederFormProps> = ({
  API_URL,
  API_URL_UPLOAD,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    fetch(API_URL, {
      ...
      .then((response) => response.json())
      .then((newCaregiver) => {
        console.log("New_Animal_Careneeder:------", newCaregiver);
        updateAnimalCareneeders(newCaregiver);
        getAnimalCareneeders();
...
export default AnimalCareneederWebForm;
