...
const AnimalCaregiverList: React.FC = () => {
  ...
  const filteredanimalcaregiversForm = animalcaregiversForm.filter((animalcaregiverForm) => {
    ...
    if (filter.location) {
      ...
      if (
        !animalcaregiverForm.location.some((option) => option.value === filter.location)
      ) {
